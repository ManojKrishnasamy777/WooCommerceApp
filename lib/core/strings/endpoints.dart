class Endpoints {
  ...
  // base url
  static const String baseUrl = "https://pos365.shop/wp-json/wc/v3/";
  ...
  static const String signUp = 'https://pos365.shop/wp-json/wc/v3/customers';
  ...
  static String payNow(String uid, String mUid) => '/pay/now/$uid/$mUid';
