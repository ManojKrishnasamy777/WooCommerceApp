...
import 'package:e_com/feature/region_settings/view/currency_view.dart';
import 'package:e_com/feature/region_settings/view/language_view.dart';
...
final routeListProvider = Provider.family
  ...
  final routeList = [
    ...
    GoRoute(
      ...
      pageBuilder: (context, state) =>
          NoTransitionPage(key: state.pageKey, child: const NoInternetPage()),
    ),
    GoRoute(
      path: RouteNames.maintenance.path,
      name: RouteNames.maintenance.name,
      pageBuilder: (context, state) =>
          NoTransitionPage(key: state.pageKey, child: const MaintenancePage()),
    ),
    GoRoute(
      path: RouteNames.invalidPurchase.path,
      name: RouteNames.invalidPurchase.name,
      pageBuilder: (context, state) => NoTransitionPage(
          key: state.pageKey, child: const InvalidPurchasePage()),
    ),
    GoRoute(
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          ...
          routes: [
            ...
            GoRoute(
              ...
              pageBuilder: (context, state) => AnimatePageRoute(
                key: state.pageKey,
                child: (animation) => const LanguageView(),
              ),
            ),
            GoRoute(
              parentNavigatorKey: rootKey,
            ...
            GoRoute(
              ...
              pageBuilder: (context, state) => AnimatePageRoute(
                key: state.pageKey,
                child: (animation) => const CurrencyView(),
              ),
            ),
            GoRoute(
              parentNavigatorKey: rootKey,
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) =>
              NoTransitionPage(key: state.pageKey, child: const WishListView()),
        ),
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) => NoTransitionPage(
              key: state.pageKey, child: const CampaignsView()),
          routes: [
            GoRoute(
        ...
        GoRoute(
          ...
          routes: [
            ...
            GoRoute(
              ...
              pageBuilder: (context, state) => AnimatePageRoute(
                key: state.pageKey,
                child: (animation) => StripePaymentView(state.extra as String),
              ),
            ),
          ],
        ),
